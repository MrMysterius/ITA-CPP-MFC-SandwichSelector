...
// ITA-CPP-MFC-SandwichSelector.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CITACPPMFCSandwichSelectorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CITACPPMFCSandwichSelectorApp-Erstellung

CITACPPMFCSandwichSelectorApp::CITACPPMFCSandwichSelectorApp()
{
...
// Das einzige CITACPPMFCSandwichSelectorApp-Objekt

CITACPPMFCSandwichSelectorApp theApp;


// CITACPPMFCSandwichSelectorApp-Initialisierung

BOOL CITACPPMFCSandwichSelectorApp::InitInstance()
{
	...
	CITACPPMFCSandwichSelectorDlg dlg;
	m_pMainWnd = &dlg;
